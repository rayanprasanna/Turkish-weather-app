...
//                break;
            case "theme":
                ...
                System.out.println("Set Theme : ___________________________?");
                break;
    ...
    private int getTheme(String themePref) {
        switch (themePref) {
            ...
            case "randomclassicdark":
                return R.style.AppTheme_Random_Classic_Dark;
            case "randomclassicblack":
                return R.style.AppTheme_Random_Classic_Black;
            case "randomfreshdark":
                return R.style.AppTheme_Random_Fresh_Dark;
            case "randomfreshblack":
                return R.style.AppTheme_Random_Fresh_Black;
            default:
