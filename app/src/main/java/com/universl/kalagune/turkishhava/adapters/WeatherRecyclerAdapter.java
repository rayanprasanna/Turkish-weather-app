package com.universl.kalagune.turkishhava.adapters;
...
import com.universl.kalagune.turkishhava.R;
import com.universl.kalagune.turkishhava.activities.MainActivity;
import com.universl.kalagune.turkishhava.models.Weather;
import com.universl.kalagune.turkishhava.models.WeatherViewHolder;
import com.universl.kalagune.turkishhava.utils.UnitConvertor;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        if (sp.getBoolean("differentiateDaysByTint", false)) {
            ...
            if (weatherItem.getNumDaysFrom(now) > 1) {
                ...
                if (weatherItem.getNumDaysFrom(now) % 2 == 1) {
                    ...
                    color = ta.getColor(i, context.getResources().getColor(R.color.colorBackground));
                }
                ta.recycle();
        ...
        if (dateArray[0].equalsIgnoreCase("Mon")){
            customViewHolder.itemDate.setText("Pazartesi" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Tue")){
            customViewHolder.itemDate.setText("Salı" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Wed")){
            customViewHolder.itemDate.setText("çarşamba" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Thu")){
            customViewHolder.itemDate.setText("Perşembe" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Fri")){
            customViewHolder.itemDate.setText("Cuma" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Sat")){
            customViewHolder.itemDate.setText("Cumartesi" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Sun")){
            customViewHolder.itemDate.setText("Pazar" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }
        ...
        customViewHolder.itemHumidity.setText(context.getString(R.string.varshawa_athi_weema) + ": " + weatherItem.getHumidity() + " %");
        customViewHolder.itemPrecipitation.setText(context.getString(R.string.rain) + ": " + weatherItem.getRain() + " %");
    }
