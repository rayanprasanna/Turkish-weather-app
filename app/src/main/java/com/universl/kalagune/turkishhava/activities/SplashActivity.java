...
import com.universl.kalagune.turkishhava.utils.CommonUtils;
...
//            imageView.setImageResource(R.drawable.wallpaper_3);
            if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                appView.setBackgroundDrawable(ContextCompat.getDrawable(this, R.drawable.turkish_splash));
            } else {
                appView.setBackground(ContextCompat.getDrawable(this, R.drawable.turkish_splash));
            }
        } else if (i == 2) {
//            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
//            imageView.setImageResource(R.drawable.wallpaper_3);
