package com.universl.kalagune.turkishhava.utils;
...
public class CommonUtils {
    ...
    private final static String THEME_DARK = "dark";
    private final static String THEME_CLASSIC_DARK = "classicdark";
    public final static String THEME_CLASSIC_BLACK = "classicblack";
    private final static String THEME_CLASSIC = "classic";
    public final static String THEME_BLACK = "black";
    private final static String THEME_CLASSIC_SKY = "classicsky";
